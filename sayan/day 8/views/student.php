                        ...
                        <?php foreach ($students as $student) : ?>
                            <div class="col-xl-3 col-sm-6">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <h5 class="font-size-15 mb-1"><a href="#" class="text-dark"><?= $student['name'] ?></a></h5>
                                        <p class="">Class <?= $student['class'] ?></p>
                                        <div>
                                            <p href="#" class="badge border font-size-15 m-1 text-dark" >Sec : <?= $student['sec'] ?></p>
                                            <p href="#" class="badge border font-size-15 m-1 text-dark" >Roll : <?= $student['id'] ?></p>
                                        </div>
                                    </div>
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="contact-links d-flex font-size-20">
                                            <div class="flex-fill">
                                            <a href="<?= base_url('students/subjects/' . $student['id']) ?>" class="btn btn-primary text-white">Add Marks</a>
                                            </div>
                                            <div class="flex-fill">
                                            <a href="<?= base_url('students/removeStudent/' . $student['id']) ?>" class="btn btn-danger text-white">Remove</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <?php foreach ($students as $student) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('students/removeStudent/' . $student['id']) ?>" class="btn btn-danger">Remove</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
